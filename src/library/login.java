...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximizedBounds(new java.awt.Rectangle(200, 300, 0, 0));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
      ...
      if(userName.equals("hailu")&&password.equals("1234")){
      Main m=new Main();
      this.hide();
      m.setVisible(true);
    }//GEN-LAST:event_btnLoginActionPerformed
else{
          JOptionPane.showConfirmDialog(this, "Username or password Do not mach");
             txtPassword.setText("");
             txtUserName.setText("");

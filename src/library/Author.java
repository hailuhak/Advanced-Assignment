  ...
  public void connect(){
   ...
   public void authorLode(){
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        String adrress=txtAddres.getText();
        String phone=txtPhone.getText();
        try {
            pre =con.prepareStatement("insert into author(AutherName,Adress,phonNo)values(?,?,?)");
     
            pre.setString(1,name);
            pre.setString(2,adrress);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            pre =con.prepareStatement("update author set AutherName=?,Adress=?,phonNo=? where Id=?");
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            pre =con.prepareStatement("delete from author where id=?");
